...
{
    [Fact]
    public void GivenCorrectCount_ThenCompletes() => Two<int>().Has().Count(2).and.Count(2);
    ...
    public void GivenAtLeastFail()
    {
        ...
        ex.Message.Is($"Expected two ints to have at least 3 items but found 2: {Two<int>().FormatValue()}");
    }
