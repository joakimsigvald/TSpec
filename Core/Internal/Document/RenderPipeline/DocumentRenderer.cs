...
internal static class DocumentRenderer
{
    internal static IReadOnlyList<SpecificationFile> Render(
        ...
        => [.. Document.Of(subject, specAssemblyName, entries, sourceRoot)
            .Select(document => new SpecificationFile(document.Name, document.Layout().Render()))];
    ...
    private static DocumentSegment[] Layout(this Document _document)
    {
        ...
        Add(new CommentSegment(
            $"Version {_document.Subject.Version}, "
            + $"generated by TSpec from {_document.GeneratedFrom}. Do not edit by hand."));
