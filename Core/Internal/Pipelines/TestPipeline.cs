...
internal abstract class TestPipeline<TSUT, TResult, TParent>(TParent parent) where TParent : Spec<TSUT, TResult>
{
    ...
    public ITestResultWithSUT<TSUT, TResult> Then(Ignore _ = default, string? because = null) => _parent.Then(because: because);
    ...
    public IAndVerify<TResult> Then<TService>(
        ...
        => _parent.Then(expression, expressionExpr!);
