...
> **Work in progress.** The generated document currently contains the subject's name and version
> only. Requirements are not yet collected.
...
before — there is no run mode, environment variable or MSBuild property to set.
